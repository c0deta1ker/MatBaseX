close all; clear all;
path_matbase    = what('2023Constantinou_BE'); path_matbase = string(path_matbase.path);
...
close all;
for i = ATOM_ZNUM
    save_fullname = path_fig_save + sprintf("Z%i_%s_BE_Cons2023", ATOM_ZNUM(i), ATOM_SYMB{i});
    calc_be_constantinou2023(ATOM_SYMB{i}, [], 1); 
