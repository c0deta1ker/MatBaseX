close all; clear all;
path_matbase    = what('2018Trzhaskovskaya_HAXPES_BE'); path_matbase = string(path_matbase.path);
...
close all;
for i = ATOM_ZNUM
    save_fullname = path_fig_save + sprintf("Z%i_%s_BE_Trzh2018", ATOM_ZNUM(i), ATOM_SYMB{i});
    calc_be_trzh2018(ATOM_SYMB{i}, [], 1); 
