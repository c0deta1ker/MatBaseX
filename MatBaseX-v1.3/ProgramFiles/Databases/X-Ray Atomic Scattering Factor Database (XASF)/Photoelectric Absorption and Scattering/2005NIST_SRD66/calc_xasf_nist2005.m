function [f1, f2] = calc_xasf_nist2005(hv, element, extrapolate, plot_results)
% [f1, f2] = calc_xasf_nist2005(hv, element, extrapolate, plot_results)
%   This is a function that calculates the atomic scattering factors for
%   all elements with 1 ≤ Z ≤ 92 in the photon energy range 2 - 433 keV . 
%   This is from the original work of NIST [1] which has now been 
...
hv_data    = XASF_DB_NIST2005.HV{ele_indx};
f1_data    = XASF_DB_NIST2005.F1{ele_indx};
f2_data    = XASF_DB_NIST2005.F2{ele_indx};
