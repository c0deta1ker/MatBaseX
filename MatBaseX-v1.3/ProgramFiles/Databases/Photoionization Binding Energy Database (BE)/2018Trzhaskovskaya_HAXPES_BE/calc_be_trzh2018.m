function [be, cls] = calc_be_trzh2018(element, corelevel, plot_results)
...
ATOM_SYMB   = string(BE_DB_Trzh2018.ATOM_SYMB);
ATOM_CL     = string(BE_DB_Trzh2018.ATOM_CL);
ATOM_BE     = table2array(BE_DB_Trzh2018.BE);
