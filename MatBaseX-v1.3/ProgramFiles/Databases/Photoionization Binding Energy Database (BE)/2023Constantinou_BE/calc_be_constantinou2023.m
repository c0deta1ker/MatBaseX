function [be, cls] = calc_be_constantinou2023(element, corelevel, plot_results)
...
%   with Z from 1 to 98 of the individual subshells. The Constantinou (2023) 
%   database is a combination of all core-level data from all previous work
%   and gives the most complete database (see Refs. [1-3]).
...
%   [3] John F. Moulder, Handbook of X-ray Photoelectron Spectroscopy, 1993.
%
%   IN:
...
ATOM_SYMB   = string(BE_DB_Constantinou2023.ATOM_SYMB);
ATOM_CL     = string(BE_DB_Constantinou2023.ATOM_CL);
ATOM_BE     = table2array(BE_DB_Constantinou2023.BE);
