...
% 1.3    :   Auger Energies
run import2matlab_AE_DB.m; close all; clear all;
% 1.4    :   Inelastic Mean Free Path (IMFP) calculators
run import2matlab_IMFP_DB.m; close all; clear all;
% 1.5    :   Photoionization Cross-Sections & Asymmetry Parameters
% 1.5A    :    Photoionization parameters
run import2matlab_XS_DB.m; close all; clear all;
% 1.5B    :    Photoionization angular anisotropy
run import2matlab_AA.m; close all; clear all;
% 1.6    :   XPS Sensitivity Factors
run import2matlab_SF.m; close all; clear all;
% 1.7    :   X-Ray Atomic Scattering Factor Database
run import2matlab_XASF_DB.m; close all; clear all;
% 1.8    :   X-Ray Absorption Edge Database
