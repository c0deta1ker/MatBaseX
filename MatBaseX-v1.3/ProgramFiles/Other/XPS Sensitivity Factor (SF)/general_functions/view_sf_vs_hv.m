function fig = view_sf_vs_hv(element, corelevel)
% fig = view_sf_vs_hv(element, corelevel)
%   This is a function that plots the XPS sensitivity factor (SF) 
