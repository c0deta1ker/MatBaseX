function ax = plt_axis_gca(plot_axes_lines, varargin)
% ax = plt_axis_gca(plot_axes_lines, varargin)
%   This function outlines a constant, global formatting for axes properties
%   and parameters for all 1D figures plotted with the PESTools package. In
%   particular, this is used for all XPS data plotting.
%
%   IN:
...
if plot_axes_lines == 1
    a = xline(0, 'Color', [0 0 0], 'LineWidth', 1.00, 'Linestyle', ':');
    b = yline(0, 'Color', [0 0 0], 'LineWidth', 1.00, 'Linestyle', ':');
