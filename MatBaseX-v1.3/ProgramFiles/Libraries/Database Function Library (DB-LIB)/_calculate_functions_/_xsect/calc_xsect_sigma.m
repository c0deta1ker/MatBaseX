function xsect_sigma = calc_xsect_sigma(hv, element, corelevel, formalism, extrapolate, plot_results)
% xsect_sigma = calc_xsect_sigma(hv, element, corelevel, formalism, extrapolate, plot_results)
...
elseif ~isempty(find(strcmpi(formalism_yl1985, formalism),1))
    xsect_sigma = calc_xsect_sigma_yehlind1985(hv, element, corelevel, extrapolate, plot_results);
% -- Trzhaskovskaya2018 formalism
elseif ~isempty(find(strcmpi(formalism_t2018, formalism),1))
    xsect_sigma = calc_xsect_sigma_trzh2018(hv, element, corelevel, extrapolate, plot_results);
% -- Cant2020 formalism
