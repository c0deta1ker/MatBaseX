function compoundNamesList = read_mpd_compounds()
% compoundNamesList = read_mpd_compounds()
...
%
%   OUT:
%   -   compoundNamesList:      1xN cell array of the element formula
...
compoundNamesList = cell(1,num_of_compounds);
for i = id_start:id_end
    compound_data       = MatData.(field_names{i});
    compoundNamesList{i-num_of_elements}   = char(compound_data.formula);
end
end