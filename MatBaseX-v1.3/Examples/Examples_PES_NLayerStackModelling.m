...
%% 1    :   Uniform and Varying Concentration Layer Stack
%% 1.1    :   Constant Experimental Geometry
close all; clear all;
lyr_mat         = {"SiO2", "Si"};
lyr_ele         = {"Si", "Si"};
lyr_cls         = {"2p3", "2p3"};
...
%% 3    :   Calculating Information Depth
close all;
eK = 1000;
theta = 0;
