...
Or, simply download & install the standalone app via the executable file [here](https://github.com/c0deta1ker/MatBaseX/releases/download/v1.3/MatBaseX_Installer.exe)!  
